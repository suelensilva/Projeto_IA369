...
JNIEXPORT jstring JNICALL Java_br_com_ia369_speechemotion_SmileJNI_SMILExtractJNI( JNIEnv* env, jobject thiz, jstring conf, jint updateProfile,jstring output){
...
JNIEXPORT jstring JNICALL Java_br_com_ia369_speechemotion_SmileJNI_SMILEndJNI(JNIEnv* env, jobject thiz , jlong cmanglob){
